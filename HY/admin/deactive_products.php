...
<head>
    ...
    <title>Hydrogen- Deactive Product Admin Page</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="title2">
            <a href="dashboard.php">Dashboard </a><span> / Deactive Products</span>
        </div>
        <section class="show-post">
           <h1 class="heading">Deactive Products</h1>
           <div class="box-container">
           <?php
                    $select_products = $conn->prepare("SELECT * FROM `products` WHERE status = 'deactive'");
                ...
                ?>
                   ...
                   <input type="hidden" name="product_id" value="<?= $fetch_products['id'];
                    ...
                    <?php } ?>
                    <div class="status" style="color: <?php if ($fetch_products['status']=='deactive'){echo "red";}?>"><?= $fetch_products['status'] ?></div>
